...
import '../utils/burger_tile.dart'; // Asegúrate de importar el widget correcto

class BurgerTab extends StatelessWidget {
  // list of donuts 
 final List burgerOnSale = [
    //[ donutFlavor, donutPrice, donutColor, imageName ]
    ["Ice Cream", "36", Colors.blue, "lib/burger/hamburguesa1.png"],
    ["Strawberry", "45", Colors.red, "lib/burger/hamburguesa2.png"],
    ["Grape Ape", "84", Colors.purple, "lib/burger/hamburguesa3.png"],
    ["Choco", "95", Colors.brown, "lib/burger/hamburguesa4.png"],
    ["Cream ice", "36", Colors.blue, "lib/burger/hamburguesa5.png"],
    ["cherry", "45", Colors.red, "lib/burger/hamburguesa6.png"],
    ["Ape Grape", "84", Colors.purple, "lib/burger/hamburguesa.png"],
    ["Cocho", "95", Colors.brown, "lib/burger/hamburguesa.png"],
  ];

  BurgerTab({super.key});
  
  get donutsOnSale => null;
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return DonutTile(
                  ...
                  onFavoriteToggle: () {
                    ('Favorite for ${burgerOnSale[index][0]} toggled');
                  },
                );
              },
            ),
